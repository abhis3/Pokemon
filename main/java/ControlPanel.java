...
public class ControlPanel extends JPanel {
    ...
    public ControlPanel() {
        ...
        custom1 = new JButton("Zaptos");
        custom1.addActionListener(new ButtonListener("Zaptos"));
        add(custom1);

        custom2 = new JButton("Charizard");
        custom2.addActionListener(new ButtonListener("Charizard"));
        add(custom2);
